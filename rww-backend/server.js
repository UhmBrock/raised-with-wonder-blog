...
app.get('/api/getBlog', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        pool.query('Select * from public.blogs where id = $1', [1], function (err, result) {
            if (err) {
                throw err;
            }
